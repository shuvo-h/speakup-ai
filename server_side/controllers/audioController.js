import { updateCardAfterConvertService } from '../services/convertCardServices';
import { updateTestIpUserAfterConvByIdService } from '../services/testIpUserService';
...
*/
export const convertFreeAudioCtl = async(req,res,next) =>{
    const {text,lang} = req.body;
